...
curl -sS -X POST "$URL/bridge/ingest" -H 'Content-Type: application/json' -H "Idempotency-Key: SNT-TEST-001" -H "X-Signature: $SIG" -d "$BODY" | jq .
